...
class DrillDetailsChart extends Component {
    ...
    dataSource() {
        ...
        function addChartLayer(svg, rows, x, y, pt, color = "red") {
        ...
        this.props.socket.subscribe('gs-message-' + timestamp).watch((response) => {
            ...
            if (this.ref) {
                ...
                addChartLayer(svg, rows, x, y, 'pitchType_Fastball', "red");
                addChartLayer(svg, rows, x, y, 'pitchType_Slider', "green");
                addChartLayer(svg, rows, x, y, 'pitchType_Curveball', "orange");
                addChartLayer(svg, rows, x, y, 'pitchType_Cutter', "blue");
                addChartLayer(svg, rows, x, y, 'pitchType_Changeup', "purple");
    ...
    render() {
        ...
        return (<div id={'graph1'} ref={r => {this.ref = r}}></div>);
    }
}
