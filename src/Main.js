...
import TeamPlayerDrillsView from "./Comparisons/TeamPlayerDrillsView";
...
const Main = () => {
	...
	return (
        ...
        <Route path='/teamplayerdrillsview' render={() => <PageContainer title={'Team Drills View'} contents={<TeamPlayerDrillsView socket={socket}/>}/>}/>
